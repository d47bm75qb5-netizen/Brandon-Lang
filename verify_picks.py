...
if __name__ == "__main__":
    ...
    print(f"Checking results for: {picks_data['date']}")
    ...
    if id_l:
        ...
        print(f"🔒 LOCK ({id_l}): {res}")  # <--- THIS IS THE FIX
    ...
    if id_v:
        ...
        print(f"🐕 VALUE ({id_v}): {res}") # <--- THIS IS THE FIX
    ...
    print("Verification Complete. History Updated.")
